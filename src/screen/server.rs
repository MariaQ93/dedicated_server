...
use super::{AppState, GameInteraction, GameSigned, Message, User, UserInfo, Users, S2D, PlayerInfos};
use bevy::prelude::*;
            ...
            .add_systems(
                ...
                |mut command: Commands,
                 ...
                 mut state: ResMut<NextState<AppState>>| {
                    ...
                    command.remove_resource::<PlayerInfos>();
...
/// do everything for handle,when recv or send message.
